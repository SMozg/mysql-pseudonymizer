...
#: ⛔ РОВНО ОДИН кандидат на строку. Несколько сдвигов ломали биекцию: лестница
#: предпочтений вправе взять второго кандидата, и тогда двое приходят к одному
...
class ShuffleProvider:
    ...
    def _permute(group, seed: int, value_class: str, group_key, key_material: bytes):
        ...
        📌 Воспроизводимость (критерий 21) держится: тот же ключ и тот же seed дают
